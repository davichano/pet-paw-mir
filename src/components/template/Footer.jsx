  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-custom-250 flex px-5 sm:px-10 min-h-[70px]">
      <div className="container mx-auto">
        <div className="flex justify-around items-center w-full text-white mt-3">
          <Link to="/feed" className="flex flex-col items-center">
            <svg className="h-[45px]" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 stroke="currentColor"
            >
              <title>paw</title>
              <path
          ...
          <Link to="/feed/true" className="flex flex-col items-center">
            <svg className="h-[45px]" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 stroke="currentColor"
            >
              <title>search</title>
