...
import {Modal} from 'flowbite-react';import { createChatIfNotExists } from '../../services/chat';
        ...
        <section className='profile-page flex flex-wrap align-top content-around w-auto px-0 mx-0 lg:justify-center'>
          ...
          <Modal show={isModalOpen} onClose={closeModal} dismissible position="center">
            <Modal.Body className="bg-custom-250 rounded-xl">
              ...
              <ul className='w-full'>
                {userAuthenticated.id === user.id && (<li className='w-full py-2 border-b border-b-white flex items-center justify-center'>
                  <Link
                    to={`/settings`}
                    onClick={closeModal}
