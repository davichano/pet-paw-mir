...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-custom-50">
      <div className="hidden md:flex w-full h-full max-w-md p-6 flex-col items-center justify-center m-12 md:max-w-md">
        <div className="w-full max-h-lg aspect-square h-auto flex items-center justify-center">
      ...
      <div className="w-full h-full max-w-lg p-6 flex flex-col items-center justify-between md:max-w-md md:justify-center md:gap-28">
        ...
        <div className="max-w-44 max-h-44 aspect-square h-auto flex items-center justify-center md:hidden">
          <div className="text-custom-50 font-bold text-2xl text-center">
            <img src={hearthPaw} alt="hearth paw" />
          </div>
        </div>
